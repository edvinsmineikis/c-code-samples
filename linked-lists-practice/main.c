...
int main() {
    ...
    while(1) {
        choice = 1337; //in case user input fails, it will be anything but int value 1-7 and reported as error
        value = 0;
        position = 0;
    ...
    return 0; // Will never get to this point, but good practice is good practice :)
}
